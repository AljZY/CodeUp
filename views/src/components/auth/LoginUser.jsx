        ...
        <div className="w-full md:w-1/2 px-4 sm:p-4 md:p-8 lg:p-12 xl:p-16">
          <div className="bg-white shadow-2xl rounded-lg p-8">
            ...
            <div className="flex justify-end">
              <Link
                to="/loginPoser"
                className="bg-yellow-400 hover:bg-yellow-500 text-white text-sm font-bold px-3 py-1 rounded shadow mb-4"
              >
                Login as Poser
              </Link>
            </div>
            ...
            <div className="text-center mt-4">
              <p>
                ...
                <Link to="/signupUser" className="underline font-semibold">
                  Register here.
                </Link>
              </p>
            </div>
